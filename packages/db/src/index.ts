...
// Local-first nutrition query builders (NUTR-02/04/07/08/13/14/17 — search/barcode lookup/
// recents/favorites/day-totals/day-type session query/recipe CRUD + per-serving aggregation)
export {
  searchLocalFoods,
  findFoodByBarcode,
  recentFoods,
