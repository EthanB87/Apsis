...
- [ ] 04-01-PLAN.md — Data/pure foundation: workout.note schema + [BLOCKING] migration, load_daily recompute-row builder + history query builders, parseDurationDigits (RUN-02/RUN-05/HOME-03..06)
...
- [ ] 04-05-PLAN.md — Run entry form + saveRun handler + Log-tab CTA (RUN-01..RUN-05)
- [ ] 04-06-PLAN.md — Finish-screen retrofit: endurance branch + 84px mini-ring + TODAY routing (RUN-06)
- [ ] 04-07-PLAN.md — TODAY dashboard + TrendChart scrub tooltip + today-breakdown sheet (HOME-01..HOME-04)
...
| 04. Run Logger & Home Dashboard | 0/8 | Not started | - |
